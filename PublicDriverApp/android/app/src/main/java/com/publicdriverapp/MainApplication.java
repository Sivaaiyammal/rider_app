...
public class MainApplication extends Application implements ReactApplication {
  ...
  public void onCreate() {
    super.onCreate();
    // Initialize NEApiServices with the application context
    NEApiServices.initialize(getApplicationContext());
    // Initialize NENative with the application context and access token
    NENative.getInstance(getApplicationContext(), NEApiServices.getAccessToken());
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
         ...
         */
        Class<?> aClass = Class.forName("com.publicdriverapp.ReactNativeFlipper");
        aClass
