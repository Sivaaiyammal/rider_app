        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <Text style={[yourRidesStyles.ridesContainerItemStatus,ride?.status=="COMPLETED"&&{color:'green'},ride?.status=="DIVERGED"&&{color:'orange'},ride?.status=="CANCELLED"&&{color:'red'}]}>{utils.getShortRideStatus(ride?.status)}</Text>
                    </View>
                </View>
                <View
