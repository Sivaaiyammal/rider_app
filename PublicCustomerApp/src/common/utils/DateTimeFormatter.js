...
export const DateTimeFormatter = {
  ...
  convertSecondsToReadable(seconds, ignoreZero = false) {
  ...
  millisecondsToReadable(ms) {
    ...
    // The logic is correct: it breaks ms into days, hours, minutes, seconds in decreasing order.
    // The output string is also correct for the intended display.
