...
const RouteSettings = () => {
  ...
  const [drivingRoute, setDrivingRoute] = useState(options[1]);
  const [cycleRoute, setCycleRoute] = useState(options[1]);
  const [navigationType, setNavigationType] = useState(options[1]);
  const [audioType, setAudioType] = useState(options[1]);
  ...
  return (
    <View style={settingsStyles.screen}>
      ...
      <ScrollView contentContainerStyle={settingsStyles.container}>
        {_renderPicker(drivingRoute, setDrivingRoute, options, "Driving Route")}
        {_renderPicker(cycleRoute, setCycleRoute, options, "Bicycle Route")}
        {_renderPicker(cycleRoute, setCycleRoute, options, "Distance Formate")}
        {_renderPicker(
          navigationType,
          setNavigationType,
          options,
        ...
        {_renderPicker(audioType, setAudioType, options, "Audio Advice Type")}
