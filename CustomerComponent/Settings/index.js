...
// components
import ThemeSelector from '../../Components/Profile/Settings/ThemeSelector';
import NewWebView from '../../Components/Common/WebView';
import LanguageScreen from '../../Components/Language/ChooseLanguageScreen';
  ...
  <TouchableOpacity style={styles.card} onPress={onPress}>
    <View
      ...
      <View style={styles.cardBody.container}>
        ...
        {subTitle ? (
          <Text style={styles.cardBody.subject}>{subTitle}</Text>
        ) : null}
      </View>
              ...
              <>
                ...
                <View style={styles.children}>
                  <View style={styles.subChild}>
                    <SettingOption
                      icon={<Home {...IconSize} />}
                      title={this.translation['home_location']}
                      subTitle="#1, Sample Street, Sample Area, Locality, City....."
                      //  onPress={() => {
                      //     this.setState({
                      //         webViewVisible: true,
                      //         webViewProps: {
                  ...
                  <View style={styles.subChild}>
                    ...
                    <SettingOption
                      icon={<Docs {...IconSize} />}
                      title={this.translation['terms_and_conditions']}
                      // onPress={() => {
                      //     this.setState({
                      //         webViewVisible: true,
                      //         webViewProps: {
                    ...
                    />
                    <SettingOption
                      icon={<Policy {...IconSize} />}
                      title={this.translation['privacy_policy']}
                      // onPress={() => {
                      //     this.setState({
                      //         webViewVisible: true,
                      //         webViewProps: {
                  ...
                  <View style={styles.subChild}>
                    ...
                    /> */}
                    <SettingOption
                      icon={<Support {...IconSize} />}
                      title={this.translation['support']}
                      //  onPress={() => {
                      //     this.setState({
                      //         webViewVisible: true,
                      //         webViewProps: {
